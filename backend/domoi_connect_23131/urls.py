"""domoi_connect_23131 URL Configuration
...
admin.site.site_header = "DOMOI CONNECT"
admin.site.site_title = "DOMOI CONNECT Admin Portal"
admin.site.index_title = "DOMOI CONNECT Admin"

# swagger
api_info = openapi.Info(
    title="DOMOI CONNECT API",
    default_version="v1",
    description="API documentation for DOMOI CONNECT App",
)
